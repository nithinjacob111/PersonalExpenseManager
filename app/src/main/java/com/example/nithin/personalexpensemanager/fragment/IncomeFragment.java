    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btnAddincome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(flag==4) {
                    flag=0;
                    MainActivity.db.execSQL("CREATE TABLE IF NOT EXISTS Income_table(Category VARCHAR(30),Amount INTEGER,Sign1 INTEGER,Description VARCHAR(100),Date1 DATE,Time1 TIME,DateAndTime DATETIME,Day1 INTEGER,Month1 INTEGER,Year1 INTEGER);");
